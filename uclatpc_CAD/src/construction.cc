...
G4VPhysicalVolume *MyDetectorConstruction::Construct()
{
	...
	auto topCap = CADMesh::TessellatedMesh::FromSTL("../ATopPMTCap.stl");
	
	auto topPMT = CADMesh::TessellatedMesh::FromSTL("../ATopPMT.stl");
	
	auto electrodeMesh = CADMesh::TessellatedMesh::FromSTL("../AElectrodeMesh.stl");
	
	auto steelRing = CADMesh::TessellatedMesh::FromSTL("../ASteelRing.stl");
	
	auto electrodeSeparationRing = CADMesh::TessellatedMesh::FromSTL("../AElectrodeSeparationRing.stl");
	
	auto PESheeth = CADMesh::TessellatedMesh::FromSTL("../APolyethyleneSheeth.stl");
	
	auto bottomPMT = CADMesh::TessellatedMesh::FromSTL("../ABottomPMT.stl");
	
	auto bottomPMTCap = CADMesh::TessellatedMesh::FromSTL("../ABottomPMTCap.stl");
